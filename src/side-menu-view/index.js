        ...
        return (
            <ScrollView style={styles.container}>
                <View style={styles.headerContainer}>
                    ...
                    {!vessel &&
                        <Text style={styles.headerText}>Do you want to logout?</Text>}
                </View>
                        ...
                        <ListItem
                            ...
                            title={
                                <View style={styles.textContainer}>
                                    <Text style={[canBeAccessedEverywhereExceptOnLogin]} >Go to startmenu</Text>
                                </View>
                            }
                            onPress={() => {
                                this.props.navigation.navigate('StartView')
                            }
                            }
                        />
                        <ListItem
