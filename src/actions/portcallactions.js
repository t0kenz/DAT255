...
export const getStatements = function (portcall) {
    return new Promise(function (resolve, reject) {
        const connection = {
            scheme: "http://",
            host: "sandbox-6.portcdm.eu",
            port: "8080"
        }
        const headers = {
        ...
        var url_prefix = connection.scheme + connection.host + ":" + connection.port;
        var url_suffix = "/pcb/port_call/" + portcall.portCallId + "/statements";
        ...
        pinch.fetch(url, {
            ...
            resolve(JSON.parse(result.bodyString));
        });
    });
}
