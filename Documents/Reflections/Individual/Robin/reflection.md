...
During this project I have learned the basics of javascript and have become somewhat familiar with react native and nodejs as I have worked with both the server side and presentation side of the application that we have developed. I have gotten experiance in working with scrum and I do believe that a lot of what I have learned can be transferred to other agile frameworks. 

As javascript is a language that is expanding in its area of applications, it is a language that I would like to have more knowledge in than I do currently. From what I have experianced, learning a new language or improving ones knowledge in a language is not something that is done by reading but by doing projects. It is necessary to do some reading to actually know what language constructs to practice when working on a project. Though this does not necessarily mean that one has to read books or documentation, reading well written code could be enough to give a hint as how to solve a problem. So my approach will be to do projects and only read when I have something that I specifically want to learn or when I run into problems.

As for scrum I feel that I need to work more on creating vertical user stories and breaking user stories down into tasks. Doing both of them in exercises is not something that I had trouble with. However doing them in a project when there are time limits and things are not going the way that you want, then it is easy to not pay the required amount of attention to user stories and tasks. This happened to us as a result of having too big scope, which lead to us creating "shallow" user stories. This in turn added confusion in what was to be developed. So when feeling pressured regarding time it is better to renegotiate the scope than to cut out part of the scrum workflow, this is something to keep in mind in future projects when working with scrum or other agile frameworks.
### How can I help someone else, or the entire team, to learn something new?
I believe that this has been one of my weaknesses during the project as my plan on how to help has been for someone else to ask me. This is a bad strategy, at least if I base it on my own behaviour as I rarely ask for help straight away. When I find something that I find really helpful or learn something that I struggled with, it would be better to share that right awway rather than waiting for someone else to experiance the same problem. 

### What is my contribution towards the team's application of scrum?
I have attended almost all of our meetings and participated in the discussions and reflections that we have done throughout the course. I also kept track of our KPI measuring our actual velocity against the expected velocity.

Taking initiatve is something that I would like to work on. I am not quite sure how to realize this, but just being more vocal is something I would consider a good start. I can achieve this by asking questions, answering questions and giving my point of view in discussions. I would say that I have made some progress on this in this course but I would like to work on it even more. 

I would say that my contribution to making the application has been good throughout the project as I have given my best every week in finishing the tasks that have been assigned to me, although there have been weeks where I did not finish. In those cases the tasks were much larger than what it seemed when planning the sprint.
...
I completed one of the goals from last week, which should have been phrased differently as basically any effort would suffice to satisfy the first goal. The reason that I wrote it so vague was that we did not really assign tasks to team members before hand. Instead we worked together as a big group, the reason was that in the last week we only had one computer that could build the project. Luckily we did complete the work on the application according to the scope we negotiated with the product owners. I did not start working on the final group report as I finished working on the application the day before the presentation. Last week I worked on sending data when navigating from the request list view to vessel info view, filtering out portcalls that are not related to towage in request list view and displaying data in the vessel info view.

A lot of the goals that I have written during the project has been either a bit too vague or too ambitious. I think that the over ambition stems from that I had the mindset that I first had to learn javascript or react or whatever language or tool was needed to start contributing. I would say that this is not something that is realistic as it takes quite a long time to feel comfortable in a language, for example I still do not feel fully comfortable using javascript, react native or nodejs. Having high ambitions is not necessarily something bad, but unrealistic ambitions are definitly not good as at least to me it is demoralizing not reaching a goal. So something that I will work on in the future is writing more concrete goals. The good side of this is that I can work on it at any part in life as goal writing is not something exclusive to programming or projects. Just writing them down is not enought though. Reflecting on wheter you have reached a goal and how you did or what you need to do to reach it is very important as it is how you learn. So to make a reflection habit realistic, it is not only important to write concrete goals but also few. Otherwise I think that I would not reflect on them as it would take too much time.

So in the future I will work on writing clear and realistic goals, and not writing too many of them. 
