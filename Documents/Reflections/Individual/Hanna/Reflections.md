...
### How can I help someone else, or the entire team, to learn something new?
- The best way to share my knowledge this week will be to discuss the solutions that me and my partner this week, in the pair programming, will come up with. We basically have the same backgrpund in programming so I think we can learn a lot by sharing our concerns and problems that come up during the sprint.


### What is my contribution towards the team’s application of scrum?
- Last week I wasn't very active in the project since I was away on vacation, which have to change during this week. I still finished the task I was assigned last week but this week I will put more work hours in the project to make up for last week.


### What is my contribution towards the team’s deliveries? That means that for the personal learning objective you will each week write down what you have achieved in relation to last week's ambition (technologies, concepts and skills learnt as well as how this was achieved), what you would like to achieve for the next week and how to make the change happen. The first week of the course you describe the current situation by motivating a learning objective. It is perfectly fine to change objective/s each week as long as you can motivate the change and you evaluate the outcome of the previous week (e.g. describing the current situation.

#### From last week
- Last week I wanted to understand the connections between the programmes used for the development, which I have. Android studio is up and running for me and I've learned how the different programmes work.
